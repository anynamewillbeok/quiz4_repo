...
namespace pfms {
    ...
    typedef enum {
      ...
      ACKERMAN_BLUE, /*!< Ackerman based steering ground vehicle - blue vehicle */
    } PlatformType; /*!< Platform Types */

    typedef enum {
      IDLE, /*!< Stationary */
      RUNNING, /*!< Executing a motion */
      STOPPING, /*!< In the process of stopping, for e-stop for instance, but not stationary yet */
    ...
    typedef enum {
      BASIC, /*!< BASIC mode of mission */
      ADVANCED /*!< ADVANCED mode of mission */
    } MissionObjective; /*!< Objective Types */
